...
tic
addpath('../Q10');
load('../../website_material/Small/A.mat');
load('../../website_material/Small/y.mat');
t_load = toc;
...
t_small_bag = toc ;
disp(['CGLS for the Small bag took : ',num2str(t_small_bag/1e-3),'[msec]'])
